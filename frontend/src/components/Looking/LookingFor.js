  ...
  return (
    <section className="bg-light-gray py-24">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-4xl font-bold text-deep-blue mb-6 animate__animated animate__fadeInUp">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          ...
          <div className="bg-emerald-green text-white p-8 rounded-lg shadow-lg transform transition duration-500 hover:scale-105 hover:shadow-2xl animate__animated animate__fadeInUp animate__delay-0.5s">
            <div className="mb-4">
            ...
            <button className="px-6 py-2 border-2 border-white text-white rounded-full transform transition-all duration-300 hover:bg-white hover:text-emerald-green">
              Apply to Teach
            </button>
          </div>

          {/* You Want to Learn Here */}
          <div className="bg-sunset-orange text-white p-8 rounded-lg shadow-lg transform transition duration-500 hover:scale-105 hover:shadow-2xl animate__animated animate__fadeInUp animate__delay-0.5s">
            <div className="mb-4">
            ...
            <button className="px-6 py-2 bg-white text-sunset-orange rounded-full transform transition-all duration-300 hover:bg-transparent hover:border-2 border-white  hover:text-white">
              Enroll Now
            </button>
          </div>
        </div>
