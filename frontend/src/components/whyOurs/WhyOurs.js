...
const WhyOurs = () => {
  return (
    <section className="relative bg-light-gray py-24 rounded-lg"> 
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between space-y-8 md:space-y-0 z-10">
       
        <div className="md:w-1/3 w-full overflow-hidden relative animate__animated animate__fadeInLeft">
          <img
        ...
        <div className="md:w-2/3 w-full space-y-6 text-center md:text-left animate__animated animate__fadeInRight md:ml-16"> {/* Added margin-left for more space */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-lg text-charcoal-gray opacity-80">
            {/* Achievement 1 */}
